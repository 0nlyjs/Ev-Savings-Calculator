...
function App() {
  ...
  }, [odometer, electricityRate, petrolPrice, petrolMileage, batteryCapacity, actualRange]);
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
          ...
          >
            ...
            <span className="text-xs font-medium text-slate-300 uppercase tracking-wider">Live Calculations</span>
          </motion.div>
        </header>
          ...
          <section className="lg:col-span-5 space-y-6">
            ...
            >
              <div className="flex items-center gap-2 mb-8">
                ...
                <h2 className="text-lg font-semibold text-slate-100">Vehicle Parameters</h2>
              </div>
              ...
              <div className="flex items-center gap-2 mb-4 mt-2">
                ...
                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">EV Specifications</span>
              </div>
            ...
            >
              ...
              <div>
                <h4 className="text-sm font-semibold text-sky-400 mb-1">Savings Insight</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
                  Switching to an EV could save you approximately <span className="text-slate-100 font-bold">{Math.round((savings / petrolCost) * 100)}%</span> on fuel costs based on your current inputs.
                </p>
              </div>
            </motion.div>
          </section>
          ...
          <section className="lg:col-span-7 space-y-6">
            ...
            >
              <div className="absolute top-0 right-0 w-1/2 h-full opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
                <img src={heroImage} alt="EV Dashboard" className="object-cover w-full h-full object-right" />
                <div className="absolute inset-0 bg-gradient-to-l from-transparent to-[#0f172a]" />
              </div>

              <div className="relative z-10">
                <p className="text-sky-400 font-medium mb-2 uppercase tracking-[0.2em] text-[10px]">Total Potential Savings</p>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-32 opacity-20 pointer-events-none">
                <svg viewBox="0 0 400 100" className="w-full h-full preserve-3d">
                  <path d="M0 80 Q 50 70, 100 85 T 200 60 T 300 75 T 400 40" fill="none" stroke="currentColor" strokeWidth="2" className="text-sky-400" />
                  <path d="M0 80 Q 50 70, 100 85 T 200 60 T 300 75 T 400 40 L 400 100 L 0 100 Z" fill="url(#grad)" className="text-sky-400" />
                  <defs>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-4">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 uppercase">Petrol</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-3 h-3 rounded-full bg-emerald-500" />
                    <span className="text-[10px] text-slate-400 uppercase">EV</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    <span className="text-slate-400 font-medium">Energy Efficiency</span>
                    <span className="text-slate-100 font-bold">{petrolMileage} km/L vs {evEfficiency} kWh/100km</span>
                  </div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-2 italic">Note: EV energy density is significantly higher, leading to better cost efficiency.</p>
                </div>
        ...
        <footer className="mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-xs text-center md:text-left">
            &copy; 2026 VoltSave. Helping you transition to a sustainable future.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-slate-500 hover:text-sky-400 transition-colors text-xs font-medium uppercase tracking-widest">Pricing</a>
            <a href="#" className="text-slate-500 hover:text-sky-400 transition-colors text-xs font-medium uppercase tracking-widest">Features</a>
            <a href="#" className="text-slate-500 hover:text-sky-400 transition-colors text-xs font-medium uppercase tracking-widest">Support</a>
          </div>
        </footer>
      </div>
    </div>
